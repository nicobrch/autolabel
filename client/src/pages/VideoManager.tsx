...
import { fetchVideos } from "@/services/api"; // Assuming fetchVideos is defined in api.ts
import { VideoCard } from "@/components/videos/VideoCard"; // Assuming VideoCard is in this path
    ...
    <div className="p-6">
      <div className="mb-6 flex items-center gap-4">
        <Button variant="outline" className="gap-2" asChild>
          <NavLink to="/"> {/* NavLink back to the project list */}
